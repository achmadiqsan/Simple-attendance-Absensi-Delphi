object DModule: TDModule
  ...
  Height = 218
  Width = 215
  object conKoneksi: TADOConnection
    Connected = True
    ConnectionString = 
      'Provider=Microsoft.Jet.OLEDB.4.0;User ID=Admin;Data Source=Absen' +
      'si.mdb;Mode=Share Deny None;Persist Security Info=False;Jet OLED' +
